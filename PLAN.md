...
- 2026-09-24 **N**: The written reason for an IV order is required for the first 2 orders, then optional (labeled so). The predicted-effect choice stays required (branch `after-cohort`).
