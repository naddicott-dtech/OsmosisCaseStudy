    ...
    <dialog ref={dialogRef} class="about" aria-labelledby="about-title">
      <form method="dialog">
        ...
        <ul>
          ...
          <li>Cell swelling in the pictures is exaggerated so it can be seen. Particle animations show the model's net water flow. They do not count real molecules.</li>
